...
class MobileApiController extends Controller
{
    ...
    public function testSubmit(Request $request, int $id): JsonResponse
    {
        ...
        $this->notifyStaffAboutGroupTestSubmission($employee, $test, $attempt);
    ...
    private function notifyStaffAboutGroupTestSubmission(Employee $student, Test $test, TestAttempt $attempt): void
    {
