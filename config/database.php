...
return [
    ...
    */
    ...
    'default' => env('DB_ACTIVE_PROFILE', 'sqlite') === 'remote' ? 'mysql_remote' : env('DB_CONNECTION', 'sqlite'),
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Профиль БД (sqlite / remote) — читать через config(), не через env() в runtime.
    |--------------------------------------------------------------------------
    */
    'active_profile' => env('DB_ACTIVE_PROFILE', 'sqlite'),
